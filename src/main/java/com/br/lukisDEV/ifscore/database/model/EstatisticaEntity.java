 ...
 import com.fasterxml.jackson.annotation.JsonBackReference;
     ...
     public class EstatisticaEntity {
       ...
       private PartidaEntity partida;
                @Builder.Default private Integer cestas = 0;
                @Builder.Default private Integer bolas2 = 0;
                @Builder.Default private Integer bolas3 = 0;
                @Builder.Default private Integer rebotes = 0;
